...
//go:generate minimock -i github.com/s0vunia/auth_microservice/internal/cache.UserCache -o user_cache_minimock.go -n UserCacheMock -p mocks
...
func (mmCreate *mUserCacheMockCreate) Expect(ctx context.Context, user *model.User) *mUserCacheMockCreate {
	...
	mmCreate.defaultExpectation.params = &UserCacheMockCreateParams{ctx, user}
...
// ExpectUserParam2 sets up expected param user for UserCache.Create
func (mmCreate *mUserCacheMockCreate) ExpectUserParam2(user *model.User) *mUserCacheMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserCacheMock.Create mock is already set by Set")
	}
...
func (mmCreate *mUserCacheMockCreate) Inspect(f func(ctx context.Context, user *model.User)) *mUserCacheMockCreate {
...
func (mmCreate *mUserCacheMockCreate) Set(f func(ctx context.Context, user *model.User) (err error)) *UserCacheMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mUserCacheMockCreate) When(ctx context.Context, user *model.User) *UserCacheMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserCacheMock.Create mock is already set by Set")
	}
	...
	expectation := &UserCacheMockCreateExpectation{
		mock:   mmCreate.mock,
		params: &UserCacheMockCreateParams{ctx, user},
	}
...
func (mmCreate *UserCacheMock) Create(ctx context.Context, user *model.User) (err error) {
	...
	mm_params := UserCacheMockCreateParams{ctx, user}
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		mm_got := UserCacheMockCreateParams{ctx, user}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.user != nil && !minimock.Equal(*mm_want_ptrs.user, mm_got.user) {
				mmCreate.t.Errorf("UserCacheMock.Create got unexpected parameter user, want: %#v, got: %#v%s\n", *mm_want_ptrs.user, mm_got.user, minimock.Diff(*mm_want_ptrs.user, mm_got.user))
			}
	...
	mmCreate.t.Fatalf("Unexpected call to UserCacheMock.Create. %v %v", ctx, user)
	return
}
